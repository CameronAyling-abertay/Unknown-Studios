...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath = { "UnrealFolderPath", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkFolder, UnrealFolderPath), METADATA_PARAMS(Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkFolder_Statics::NewProp_UnrealFolderPath_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath = { "WwiseFolderPath", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAkFolder, WwiseFolderPath), METADATA_PARAMS(Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAkFolder_Statics::NewProp_WwiseFolderPath_MetaData)) };
	...
	IMPLEMENT_CLASS(UAkFolder, 3414442703);
